...
def start_server():
    ...
    server_socket1.bind(('127.0.0.1', portnum+3)) # specify host (itself) and port number 9999
    server_socket1.listen(5)
    server_socket2 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    server_socket2.bind(('127.0.0.1', portnum+4)) # specify host (itself) and port number 9999
    server_socket2.listen(5)
    server_socket3 = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    server_socket3.bind(('127.0.0.1', portnum+5)) # specify host (itself) and port number 9999
